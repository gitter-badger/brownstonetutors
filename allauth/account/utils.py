...
from compat import SiteProfileNotAvailable, sha_constructor, md5_constructor
...
def get_gravatar(email, size=80, default='identicon'):
    ...
    """
    if accounts_settings.MUGSHOT_GRAVATAR_SECURE:
...
def get_protocol():
    ...
    This can be either 'http' or 'https' depending on ``_USE_HTTPS``
    setting.
    """
    protocol = 'http'
    if getattr(settings, '_USE_HTTPS', accounts_settings.DEFAULT_USE_HTTPS):
        protocol = 'https'
    return protocol
